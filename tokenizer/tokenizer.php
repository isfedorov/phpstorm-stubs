...
define('T_OBJECT_OPERATOR', 388);
/**
 * @since 8.0
 */
define('T_NULLSAFE_OBJECT_OPERATOR', 389);
define('T_DOUBLE_ARROW', 390);
define('T_COMMENT', 391);
define('T_DOC_COMMENT', 392);
define('T_OPEN_TAG', 393);
define('T_OPEN_TAG_WITH_ECHO', 394);
define('T_CLOSE_TAG', 395);
define('T_WHITESPACE', 396);
define('T_START_HEREDOC', 397);
define('T_END_HEREDOC', 398);
define('T_DOLLAR_OPEN_CURLY_BRACES', 399);
define('T_CURLY_OPEN', 400);
define('T_PAAMAYIM_NEKUDOTAYIM', 401);
define('T_DOUBLE_COLON', 401);
define('T_NS_SEPARATOR', 402);
define('T_ELLIPSIS', 403);
define('T_COALESCE', 404);
define('T_POW', 405);
define('T_POW_EQUAL', 406);
/**
 * @since 8.1
 */
define('T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG', 407);
/**
 * @since 8.1
 */
define('T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG', 408);
define('T_BAD_CHARACTER', 409);
