 ...
 */
function idn_to_ascii(string $domain, int $flags = IDNA_NONTRANSITIONAL_TO_ASCII|IDNA_NONTRANSITIONAL_TO_UNICODE, int $variant = INTL_IDNA_VARIANT_UTS46, &$idna_info): string|false {}
 ...
 */
function idn_to_utf8(string $domain, int $flags = IDNA_NONTRANSITIONAL_TO_ASCII|IDNA_NONTRANSITIONAL_TO_UNICODE, int $variant = INTL_IDNA_VARIANT_UTS46, &$idna_info): string|false {}
