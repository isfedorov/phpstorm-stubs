...
class Collator
{
    ...
    public function sort(
        array &$array,
        #[LanguageAware(['8.0' => 'int'], default: '')] #[EV([Collator::SORT_REGULAR])] $flags = Collator::SORT_REGULAR
    ): bool {}
...
class NumberFormatter
{
    ...
    public function format(
        ...
        #[LanguageAware(['8.0' => 'int'], default: '')] $type = NumberFormatter::TYPE_DEFAULT
    ): string|false {}
    ...
    #[TentativeType]
    public function getLocale(
        #[LanguageAware(['8.0' => 'int'], default: '')] #[EV([Locale::VALID_LOCALE, Locale::ACTUAL_LOCALE])] $type = Locale::ACTUAL_LOCALE
    ): string|false {}
...
class Transliterator
{
    ...
    public static function create(
        ...
        #[LanguageAware(['8.0' => 'int'], default: '')] #[EV([Transliterator::FORWARD, Transliterator::REVERSE])] $direction = Transliterator::FORWARD
    ): ?Transliterator {}
