...
{
    private InterfaceNamespaceCheck $check;

    protected function setUp(): void
    {
        parent::setUp();
        $this->check = new InterfaceNamespaceCheck();
    }

    private function makeInterface(string $id, ?string $namespace): PHPInterface
    {
    ...
    {
        $iface = $this->makeInterface('\Random\Engine', '\Random');
    ...
    {
        $iface = $this->makeInterface('\Foo\Bar\Baz\MyInterface', '\Foo\Bar\Baz');
    ...
    {
        $iface = $this->makeInterface('\Random\Engine', '\WrongNamespace');
    ...
    {
        $iface = $this->makeInterface('\Countable', 'SomeNamespace');
