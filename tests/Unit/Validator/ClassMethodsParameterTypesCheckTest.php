...
use StubTests\Sources\Validator\ClassMethodsParameterTypesCheck;
...
class ClassMethodsParameterTypesCheckTest extends CheckTestCase
{
    ...
    /**
     * Create a PHPParameter with the given name, type and optional version/LanguageLevelTypeAware data.
     */
    ...
    public function testVersionExcludedStubParamIsIgnored(): void
    {
        ...
        $stubParams = [
            $this->makeParam('a', $this->createType('string')),
            $this->makeParam('b', $this->createType('bool'), '8.1'), // not in PHP 8.0
        ];
    ...
    public function testVersionRemovedStubParamIsIgnored(): void
    {
        ...
        $stubParams = [
            $this->makeParam('a', $this->createType('string')),
            $this->makeParam('b', $this->createType('int'), null, '7.4'), // removed in 8.0
        ];
    ...
    public function testLanguageLevelTypeAwareResolvesForVersion(): void
    {
        ...
        $stubParams = [$this->makeParam('handle', null, null, null, ['8.0' => 'CurlHandle'], '')];
    ...
    public function testSameNamedVariadicParamDeduplicationSucceeds(): void
    {
        ...
        $stubParams = [
            $this->makeParam('values', $this->createType('int'), null, '7.4'),
            $this->makeParam('values', $this->createType('string'), null, null, null, null, true), // variadic
        ];
