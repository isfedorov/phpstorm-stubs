...
class ClassMethodsParametersCountCheckTest extends CheckTestCase
{
    ...
    /**
     * Build a PHPMethod with the given name, parameters, and optional version bounds.
     */
    ...
    public function testParameterCountMismatchIsFailure(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', [$this->makeParam('a'), $this->makeParam('b')])]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', [$this->makeParam('a')])] // one param fewer
        );
    ...
    public function testMultipleMismatchedMethodsAllReported(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('foo', [$this->makeParam('x'), $this->makeParam('y')]),
                $this->makeMethod('bar', [$this->makeParam('z')]),
            ]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('foo', [$this->makeParam('x')]),          // mismatch: stub has 1, refl has 2
                $this->makeMethod('bar', [$this->makeParam('z')]),          // match
            ]
        );
    ...
    public function testMethodMissingFromStubsIsNotReportedAsParameterMismatch(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('onlyInReflection', [$this->makeParam('x')])]
        );
    ...
    public function testParamNotYetAddedIsExcludedFromCount(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('init', [$this->makeParam('a')])]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('init', [
                $this->makeParam('a'),
    ...
    public function testParamAddedAtExactSinceVersionIsIncluded(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('init', [$this->makeParam('a'), $this->makeParam('b')])]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('init', [
    ...
    public function testParamAtExactRemovedVersionIsStillIncluded(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('legacy', [$this->makeParam('a'), $this->makeParam('b')])]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
    ...
    public function testParamAfterRemovedVersionIsExcluded(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('legacy', [$this->makeParam('a')])]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('legacy', [
    ...
    public function testVersionWindowParamCountedOnlyWithinRange(): void
    {
        ...
        foreach (['7.0', '7.1', '7.2'] as $version) {
            ...
            $reflClass = $this->createMockClassWithProperties(
                $className, null, null, null,
                [$this->makeMethod('go', array_fill(0, $expected, $this->makeParam('_')))]
            );
            $stubClass = $this->createMockClassWithProperties(
                $className, null, null, null,
                [$stubMethod]
    ...
    public function testChildMethodOverridesParentForParameterCountCheck(): void
    {
        ...
        $childStub = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', [$this->makeParam('a'), $this->makeParam('b')])] // correct in child
        );
        $childStub->parentClass = $parentStub;
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', [$this->makeParam('a')])] // mismatch
        );
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMismatch(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            ...
            [
                $this->makeMethod('doWork', [$this->makeParam('a'), $this->makeParam('b')]),
                $this->makeMethod('other',  [$this->makeParam('x')]),
            ]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('doWork', [$this->makeParam('a')]),  // mismatch — known problem
                $this->makeMethod('other',  [$this->makeParam('x')]),  // match
            ]
        );
    ...
    public function testMethodLevelKnownProblemDoesNotSuppressOtherMismatches(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            ...
            [
                $this->makeMethod('doWork', [$this->makeParam('a'), $this->makeParam('b')]),
                $this->makeMethod('other',  [$this->makeParam('x'), $this->makeParam('y')]),
            ]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('doWork', [$this->makeParam('a')]),  // mismatch — known problem
                $this->makeMethod('other',  [$this->makeParam('x')]),  // mismatch — NOT a known problem
            ]
        );
