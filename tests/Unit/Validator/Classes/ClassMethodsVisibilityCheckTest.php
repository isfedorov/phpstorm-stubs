...
class ClassMethodsVisibilityCheckTest extends CheckTestCase
{
    ...
    /**
     * Build a PHPMethod with the given name, visibility, and optional version bounds.
     */
    ...
    public function testBothProtectedIsSuccess(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'protected')]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'protected')]
    ...
    public function testBothPrivateIsSuccess(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'private')]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'private')]
    ...
    public function testMultipleMethodsMixedResultsAreAllReported(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('okMethod',  'public'),    // matches
                $this->makeMethod('badMethod', 'protected'), // mismatch: refl=protected, stub=public
            ]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('okMethod',  'public'),
                $this->makeMethod('badMethod', 'public'),    // wrong
            ]
        );
    ...
    public function testMethodMissingInStubsIsNotReportedAsVisibilityMismatch(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('onlyInReflection', 'public')]
        );
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'protected')] // mismatch: stub is public
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'public')]
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMismatch(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            ...
            [
                $this->makeMethod('okMethod', 'public'),    // matches
                $this->makeMethod('doWork',   'protected'), // mismatch — covered by known problem
            ]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [
                $this->makeMethod('okMethod', 'public'),
                $this->makeMethod('doWork',   'public'), // wrong, but known problem
            ]
        );
    ...
    public function testStubMethodOutsideVersionRangeIsSkipped(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('newMethod', 'protected')]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('newMethod', 'public', '8.1')] // not available in 8.0
        );
    ...
    public function testPsUnreservePrefixMethodVisibilityMismatchIsReported(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('throw', 'public')]
        );
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('PS_UNRESERVE_PREFIX_throw', 'protected')] // mismatch
        );
    ...
    public function testPsUnreservePrefixMethodVisibilityMatchIsSuccess(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('PS_UNRESERVE_PREFIX_throw', 'public')]
        );
    ...
    public function testVisibilityFromInterfaceMismatchIsReported(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('interfaceMethod', 'public')]
        );

        $iface = $this->makeInterface('\MyInterface', [
            $this->makeMethod('interfaceMethod', 'protected'), // stub says protected → mismatch
        ]);
    ...
    public function testChildMethodOverridesParentVisibility(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'public')] // reflection: public (child override)
        );
        ...
        $childStub = $this->createMockClassWithProperties(
            $className, null, null, null,
            [$this->makeMethod('doWork', 'public')] // child re-declares: public
        );
        $childStub->parentClass = $parentStub;
