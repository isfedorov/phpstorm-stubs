...
class ClassInterfacesCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\Exception';
        $throwable = $this->makeInterface('\Throwable');
        ...
        $stubThrowable = $this->makeInterface('\Throwable');
    ...
    public function testStubsDeclareSpuriousInterface(): void
    {
        ...
        $stubFakeIface = $this->makeInterface('\FakeInterface');
    ...
    public function testTransitiveInterfaceFromReflectionDoesNotCauseFalsePositive(): void
    {
        ...
        $className = '\Generator';
        $iterator = $this->makeInterface('\Iterator');
        ...
        $stubIterator = $this->makeInterface('\Iterator');
    ...
    public function testClassWithMultipleMatchingInterfaces(): void
    {
        ...
        $interfaces = [
            $this->makeInterface('\IteratorAggregate'),
            $this->makeInterface('\ArrayAccess'),
            $this->makeInterface('\Serializable'),
            $this->makeInterface('\Countable'),
        ];
