...
use StubTests\Sources\Validator\ClassMethodsOptionalParametersCheck;
...
class ClassMethodsOptionalParametersCheckTest extends CheckTestCase
{
    ...
    public function testOptionalInStubsButNotReflectionIsSuccess(): void
    {
        ...
        $className  = '\MyClass';
        $reflParams = [$this->makeParam('x', false)];
        $stubParams = [$this->makeParam('x', true)]; // optional in stubs only
    ...
    public function testParamMissingFromStubMethodIsNotReportedAsOptionalMismatch(): void
    {
        ...
        $className  = '\MyClass';
        $reflParams = [$this->makeParam('a', false), $this->makeParam('b', true)];
        $stubParams = [$this->makeParam('a', false)]; // 'b' absent
    ...
    public function testMethodMissingFromStubsIsNotReportedAsOptionalMismatch(): void
    {
        ...
        $className  = '\MyClass';
        $reflParams = [$this->makeParam('b', true)];
    ...
    public function testOptionalParamMismatchInheritedFromParentIsChecked(): void
    {
        ...
        $reflParams = [$this->makeParam('x', true)]; // optional in reflection
        $stubParams = [$this->makeParam('x', false)]; // not optional in stubs
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $reflParams = [$this->makeParam('x', true)];
        $stubParams = [$this->makeParam('x', false)]; // mismatch
