...
class ReturnTypesCheckTest extends CheckTestCase
{
    ...
    public function testMatchingReturnTypes(): void
    {
        ...
        $check = new ReturnTypesCheck($reflectionProvider);
    ...
    public function testMatchingReturnTypesForMethod(): void
    {
        // Arrange
        $methodId = 'MyClass::myMethod';
        $returnType = $this->createType('string');

        $reflectionMethod = $this->createMockMethod('myMethod', [], $returnType);
        $reflectionClass = $this->createMockClass('MyClass', [$reflectionMethod]);

        $stubMethod = $this->createMockMethod('myMethod', [], $returnType);
    ...
    public function testLanguageLevelTypeAwareWithMultipleVersions(): void
    {
        ...
        $check73 = new ReturnTypesCheck($reflectionProvider73);
        ...
        $check74 = new ReturnTypesCheck($reflectionProvider74);
        ...
        $check75 = new ReturnTypesCheck($reflectionProvider75);
        ...
        $check80 = new ReturnTypesCheck($reflectionProvider80);
        ...
        $check81 = new ReturnTypesCheck($reflectionProvider81);
    ...
    /**
     * Create a mock function with LanguageLevelTypeAware data.
     */
    private function createMockFunctionWithVersionAwareType(
        ...
        $function = $this->getMockBuilder(\StubTests\Sources\Parsers\Entities\Model\PHPFunction::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['getId', 'getName', 'getParameters', 'getReturnTypeFromSignature', 'getLanguageLevelTypes', 'getDefaultType'])
            ->getMock();

        $function->method('getId')->willReturn($name);
        $function->method('getName')->willReturn($name);
        $function->method('getParameters')->willReturn([]);
        $function->method('getReturnTypeFromSignature')->willReturn($signatureType);
        $function->method('getLanguageLevelTypes')->willReturn($languageLevelTypes);
        $function->method('getDefaultType')->willReturn($defaultType);
