...
class InterfaceParentInterfacesCheckTest extends CheckTestCase
{
    ...
    /**
     * Build a resolved stub interface (has both getName() and getId() set).
     * After ClassHierarchyResolver, found parents have getId() !== null.
     */
    private function makeInterface(string $id, array $parentInterfaces = []): PHPInterface
    {
    ...
    public function testInterfaceWithResolvedParentSucceeds(): void
    {
        ...
        $outerIteratorStub = $this->makeInterface('\OuterIterator', [$iteratorStub]);
    ...
    public function testInterfaceWithMultipleResolvedParentsSucceeds(): void
    {
        ...
        $backedEnumStub  = $this->makeInterface('\BackedEnum', [$unitEnumStub, $stringableStub]);
    ...
    public function testMissingDirectParentIsFailure(): void
    {
        ...
        $outerIteratorStub = $this->makeInterface('\OuterIterator', [$missingParent]);
    ...
    public function testMultipleMissingParentsAreEachReported(): void
    {
        ...
        $iface    = $this->makeInterface('\MyInterface', [$missingA, $missingB]);
    ...
    public function testMissingGrandparentIsReported(): void
    {
        ...
        $iteratorStub       = $this->makeInterface('\Iterator', [$missingTraversable]);
        $seekableStub       = $this->makeInterface('\SeekableIterator', [$iteratorStub]);
    ...
    public function testAllAncestorsResolvedInDeepHierarchySucceeds(): void
    {
        ...
        $ifaceB = $this->makeInterface('\InterfaceB', [$ifaceA]);
        $ifaceC = $this->makeInterface('\InterfaceC', [$ifaceB]);
    ...
    public function testMissingAncestorAtAnyDepthIsReported(): void
    {
        ...
        $missingA = $this->makeUnresolvedParent('InterfaceA');
        $ifaceB   = $this->makeInterface('\InterfaceB', [$missingA]);
        $ifaceC   = $this->makeInterface('\InterfaceC', [$ifaceB]);
    ...
    public function testCyclicParentChainDoesNotCauseInfiniteLoop(): void
    {
        ...
        $ifaceB = $this->makeInterface('\IfaceB', [$ifaceA]);
    ...
    public function testSameMissingParentReferencedTwiceIsReportedOnce(): void
    {
        ...
        $iface     = $this->makeInterface('\MyInterface', [$missingA1, $missingA2]);
    ...
    public function testInterfaceLevelKnownProblemSkipsCheck(): void
    {
        ...
        $iface         = $this->makeInterface($interfaceId, [$missingParent]);
