...
use StubTests\Sources\Parsers\Serializers\PHPInterfaceSerializer;
...
class PHPInterfaceSerializerTest extends TestCase
{
    ...
    public function testRoundTripPreservesBasicFields(): void
    {
        ...
        $original->setSinceVersion('8.0');
        $original->setRemovedVersion(null);
        ...
        $this->assertSame('8.0', $restored->getSinceVersion());
    }
}
