...
use StubTests\Framework\Parsers\Entities\Stubs\Types\TypeNodeConverter;
...
class DnfTypeParsingTest extends TestCase
{
    ...
    public function testTypeNodeConverterRoundtrip(string $typeStr, string $expected): void
    {
        ...
        $typeNode = new class($typeStr) implements \StubTests\Sources\Parsers\Entities\Stubs\Nodes\TypeNode {
    ...
    {
        $typeNode = new class('int|(\\Foo&\\Bar)') implements \StubTests\Sources\Parsers\Entities\Stubs\Nodes\TypeNode {
    ...
    {
        $typeNode = new class('(\\Foo&\\Bar)') implements \StubTests\Sources\Parsers\Entities\Stubs\Nodes\TypeNode {
    ...
    public function testTypeNodeConverterNullableDnfIsUnionNotNullable(): void
    {
        ...
        $typeNode = new class('null|(\\Foo&\\Bar)') implements \StubTests\Sources\Parsers\Entities\Stubs\Nodes\TypeNode {
    ...
    public function testIntersectionReturnTypeParsedFromStub(): void
    {
        ...
        $parser = new \StubTests\Sources\Parsers\Entities\Stubs\StubFunctionParser();
