...
use StubTests\Sources\Parsers\Entities\Reflection\ReflectionPropertyParser;
...
class ReflectionPropertyParserTest extends TestCase
{
    ...
    public function testItParsesPropertyVisibility()
    {
        ...
        self::assertEquals('public', $property->getAccess()->toString());
        ...
        self::assertEquals('protected', $property2->getAccess()->toString());
        ...
        self::assertEquals('private', $property3->getAccess()->toString());
    }
    ...
    public function testItParsesIntersectionPropertyType()
    {
        ...
        self::assertInstanceOf(\StubTests\Sources\Parsers\Entities\Model\Types\IntersectionType::class, $property->getType());
