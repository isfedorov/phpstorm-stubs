...
class DefaultTypeParserTest extends BaseTestCase
{
    ...
    public function testParseTypeFromSignatureOnly()
    {
        ...
        self::assertNull($property->getTypeFromPhpDoc());
        self::assertNull($property->getLanguageLevelTypes());
        self::assertNull($property->getDefaultType());
    }
    ...
    public function testParseTypeFromPhpDocOnly()
    {
        ...
        self::assertEquals('string', $property->getTypeFromPhpDoc());
        self::assertNull($property->getLanguageLevelTypes());
        self::assertNull($property->getDefaultType());
    }
    ...
    public function testParseTypeFromBothSignatureAndPhpDoc()
    {
        ...
        self::assertEquals('string', $property->getType()->toString());
        self::assertEquals('string|null', $property->getTypeFromPhpDoc());
        self::assertNull($property->getLanguageLevelTypes());
    }
    ...
    public function testParseComplexPhpDocTypes()
    {
        ...
        self::assertEquals('array<string,int>', $properties[0]->getTypeFromPhpDoc());

        // Callable type (PhpDocumentor simplifies callable signatures to just "callable")
        self::assertEquals('callable', $properties[1]->getTypeFromPhpDoc());
    }
    ...
    public function testParsePreservesOriginalTypeStrings()
    {
        ...
        self::assertSame('string|null', $property->getTypeFromPhpDoc());
    }
    ...
    public function testParseLanguageLevelTypeAwareWithSingleVersion()
    {
        ...
        self::assertEquals(['8.0' => 'CurlHandle'], $property->getLanguageLevelTypes());
        self::assertEquals('resource', $property->getDefaultType());
    }
    ...
    public function testParseLanguageLevelTypeAwareWithMultipleVersions()
    {
        ...
        self::assertEquals('resource|false', $property->getDefaultType());
    }
    ...
    public function testParseLanguageLevelTypeAwareWithEmptyDefault()
    {
        ...
        self::assertSame('', $property->getDefaultType());
        self::assertNotNull($property->getDefaultType());
    }
...
class TestClass {
    ...
    public $prop;
        ...
        self::assertEquals(['8.0' => 'string'], $property->getLanguageLevelTypes());
        self::assertNull($property->getDefaultType());
    }
...
class TestClass {
    ...
    public $prop;
        ...
        self::assertEquals(['8.0' => 'int'], $property->getLanguageLevelTypes());
        self::assertEquals('', $property->getDefaultType());
    }
...
class TestClass {
    ...
    public $prop;
        ...
        self::assertEquals(['8.0' => 'first'], $property->getLanguageLevelTypes());
        self::assertEquals('first_default', $property->getDefaultType());
    }
...
class TestClass {
    ...
    public $prop;
        ...
        self::assertEquals([], $property->getLanguageLevelTypes());
        self::assertEquals('fallback', $property->getDefaultType());
    }
    ...
    public function testParseLanguageLevelTypeAwareVersionsAreStrings()
    {
        ...
        $types = $property->getLanguageLevelTypes();
    ...
    public function testParseAllThreeSourcesSimultaneously()
    {
        ...
        self::assertEquals('resource|false', $property->getTypeFromPhpDoc());
        self::assertEquals(['8.0' => 'Socket|false'], $property->getLanguageLevelTypes());
        self::assertEquals('resource|false', $property->getDefaultType());
    }
    ...
    public function testParseRealWorldExample_CurlResource()
    {
        ...
        self::assertEquals('resource|false', $function->getReturnTypeFromPhpDoc());
    ...
    public function testParseRealWorldExample_SocketResource()
    {
        ...
        self::assertEquals('Socket|false', $property->getLanguageLevelTypes()['8.0']);
        self::assertEquals('resource|false', $property->getDefaultType());
    }
    ...
    public function testParsePropertyWithAllTypeInformation()
    {
        ...
        // Comprehensive check
        self::assertNotNull($property->getTypeFromPhpDoc());
        self::assertNotNull($property->getLanguageLevelTypes());
        self::assertNotNull($property->getDefaultType());

        // Verify structure
        self::assertIsString($property->getTypeFromPhpDoc());
        self::assertIsArray($property->getLanguageLevelTypes());
        self::assertIsString($property->getDefaultType());
    }
    ...
    public function testParseMethodReturnTypeWithAllTypeInformation()
    {
        ...
        self::assertEquals('resource|false', $function->getReturnTypeFromPhpDoc());
        self::assertIsArray($function->getLanguageLevelTypes());
        self::assertEquals('CurlHandle|false', $function->getLanguageLevelTypes()['8.0']);
    }
...
class TestClass {
    ...
    public $prop;
        ...
        self::assertNull($property->getLanguageLevelTypes());
        self::assertEquals('string', $property->getDefaultType());
    }
...
class TestClass {
    ...
    public function testParseHandlesNullValuesGracefully()
    {
        ...
        self::assertInstanceOf(\StubTests\Sources\Parsers\Entities\Model\Types\NoType::class, $result->typeFromSignature);
