...
class ClassInterfaceFqnsExtractorTest extends TestCase
{
    ...
    {
        $class = new PHPClass();
        $class->interfaces = [$this->makeInterface('\Throwable', 'Throwable')];
    ...
    {
        $class = new PHPClass();
        $class->interfaces = [$this->makeInterface('\Random\Engine', 'Engine')];
    ...
    {
        $class = new PHPClass();
        $class->interfaces = [$this->makeInterface('\Foo\Bar\Baz\MyInterface', 'MyInterface')];
    ...
    public function testSkipsInterfaceWithNullIdAndNullName(): void
    {
        ...
        $class = new PHPClass();
        $class->interfaces = [$iface1, $iface2];
    ...
    public function testMixedResolvedAndUnresolvedInterfaces(): void
    {
        ...
        $class = new PHPClass();
        $class->interfaces = [$linked, $unlinked];
