...
class AllStubsDataProviderTest extends TestCase
{
    ...
    public function testSetStubsRootPathUpdatesPath()
    {
        $provider = new AllStubsDataProvider();
        $newPath = '/tmp/test-stubs';

        $provider->setStubsRootPath($newPath);

        self::assertEquals($newPath, $provider->getStubsRootPath());
    }
