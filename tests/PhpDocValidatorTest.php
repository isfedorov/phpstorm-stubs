...
class PhpDocValidatorTest extends ValidatorTestBase
{
    ...
    /**
     * Collision-safe test name: replace \ with . so that \Foo_Bar and \Foo\Bar
     * produce different strings (base class replaces both \ and _ with _).
     */
     ...
     */
    private static function getAllStubEntities(ParsedDataStorageManager $stubs): iterable
    {
