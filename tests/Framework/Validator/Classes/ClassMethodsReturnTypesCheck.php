...
class ClassMethodsReturnTypesCheck extends AbstractMethodFlagCheck
{
    ...
    protected function describeMismatch(
        ...
        $reflType = $this->getReturnTypeString($reflMethod, $phpVersion);
        $stubType = $this->getReturnTypeString($stubMethod, $phpVersion);
        ...
        if ($normalizedStub !== null && str_contains($normalizedStub, 'static')) {
            ...
            $primitives = ['array', 'bool', 'callable', 'false', 'float', 'int', 'iterable',
                           'mixed', 'never', 'null', 'object', 'resource', 'self', 'string',
                           'true', 'void'];
