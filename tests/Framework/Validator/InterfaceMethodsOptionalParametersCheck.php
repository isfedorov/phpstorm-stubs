...
/**
 * Validates that parameters optional in reflection are also optional in stub interface methods.
 */
class InterfaceMethodsOptionalParametersCheck extends ClassMethodsOptionalParametersCheck
{
