 ...
 *
 * Template methods that can be overridden to support enums / interfaces:
 * - findEntityById()
 * - getEntityLabel()
 * - getEntityType()
...
abstract class AbstractConstantFlagCheck extends AbstractClassCheck
{
     ...
     * Override in subclasses to support interfaces or enums instead of classes.
     */
     ...
     * Override to return "Interface" or "Enum" in type-specific subclasses.
     */
    ...
    /**
     * Template method: entity type for known-problem lookups at the entity level.
     * Override to return EntityType::INTERFACE_TYPE or EntityType::ENUM_TYPE in subclasses.
     */
    ...
    /**
     * Template method: entity type for known-problem lookups at the constant level.
     * Override to return EntityType::INTERFACE_CONSTANT or EntityType::ENUM_CONSTANT in subclasses.
     */
    ...
    public function run(ParsedDataStorageManager $stubs, string $entityId, string $phpVersion): CheckResultSet
    {
        ...
        $reflEntity = $this->findEntityById($reflection, $entityId);
        if ($reflEntity === null) {
            $results->addFailure($entityId, "{$label} {$entityId} not found in reflection data");
            return $results;
        }

        $stubEntity = $this->findEntityById($stubs, $entityId);
        if ($stubEntity === null) {
