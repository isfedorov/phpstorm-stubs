...
class FunctionTentativeReturnTypeCheck extends AbstractCallableCheck
{
    ...
    public function run(ParsedDataStorageManager $stubs, string $entityId, string $phpVersion): CheckResultSet
    {
        ...
        $reflTentative = method_exists($reflCallable, 'hasTentativeReturnType')
            && (bool) $reflCallable->hasTentativeReturnType();
        $stubTentative = method_exists($stubCallable, 'hasTentativeReturnType')
            && (bool) $stubCallable->hasTentativeReturnType();
