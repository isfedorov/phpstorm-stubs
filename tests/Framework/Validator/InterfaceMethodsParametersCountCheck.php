...
/**
 * Validates that the number of parameters on interface methods in stubs matches reflection.
 */
class InterfaceMethodsParametersCountCheck extends ClassMethodsParametersCountCheck
{
