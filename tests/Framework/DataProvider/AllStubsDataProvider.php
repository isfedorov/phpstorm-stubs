...
class AllStubsDataProvider implements StubsDataProvider
{
    ...
    /**
     * Set the stubs root path.
     *
     * @param string $path The absolute path to the stubs root directory
     */
    public function setStubsRootPath(string $path): void
    {
        $this->stubsRootPath = $path;
    }
