...
function deflate_init(int $encoding, #[LanguageLevelTypeAware(['8.3' => 'object|array'], default: 'array')] $options = []) {}
...
function inflate_init(int $encoding, #[LanguageLevelTypeAware(['8.3' => 'object|array'], default: 'array')] $options = []) {}
